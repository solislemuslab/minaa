...
// std::vector<std::vector<double>> matrix {{85,  12,  36,  83,  50,  96,  12,  1 },
...
// std::vector<std::array<unsigned, 2>> alignment = Hungarian::hungarian(matrix);
// // Write the results to a csv file
// std::string alignf = writeResults(alignment);
